...
class Unet(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder_convs = [unet_parts.double_conv(*x) for x in zip(channels_in,channels_out)]
        ...
        self.decoder_convs = [unet_parts.double_conv(*x) for x in zip(channels_out,channels_in)][:0:-1]
